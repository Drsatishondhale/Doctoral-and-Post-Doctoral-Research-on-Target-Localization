function [ X_kalman,Y_kalman, X_V_kalman, Y_V_kalman] = kf( X,P,grnn_x, grnn_y,velocity_est,t)
...
%   Detailed explanation goes here
       ...
       U = [0; 0];            % Control Input (acceleration)
   ...
   % Prediction Stage
     ...
     % Update Stage  
       X_meas = [grnn_x; grnn_y; velocity_est(1); velocity_est(2)];             % Observation Equation
