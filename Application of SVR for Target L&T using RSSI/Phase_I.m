351162,-5.54145369385221,-5.69497394237543,-3.76668831730977,-4.39810735350420,-4.23944997871815,-7.35708028292469,-6.03864907082873,-11.5683157550638,-12.3119075585539,-12.9021730521670,-14.9303409621525,-15.2588101642827,-16.7911757718198,-15.3874256436462,-17.0047181779088,-20.6183935200397,-19.6795172761132,-20.1466473065832,-18.6778411870672,-21.2113401361958,-22.1560545170119,-16.0069824284260,-16.5395435488504,-18.7521483344411,-20.0756332455221,-19.2357811188228,-21.3475644582398,-19.7692499668508,-26.1047515585853,-24.9469060188932,-24.1198131342919];
Target = [10,12,15,16,18,22,22,24,26,30,30,32,34,36,38,43,48,45,46,47,50,49,51,53,55,57,59,61,63,65,70,69,71,73,75,80,79,81,80,80;10,15,21,25,30,36,45,45,50,56,60,65,70,75,80,81,78,85,72,69,66,63,64,70,66,67,68,69,70,71,75,73,74,75,76,80,78,79,75,100];
spread =3.5;
Loc_est_GRNN = newgrnn(RSSI_input_Vector,Target,spread);
...
% Generating trajectory for the mobile node  
    for t = 1:no_of_positions          
       ...
       legend('Anchor Location','Actual Target Location','Trilateration based Estimation','GRNN based Estimation','SVR based Estimation','Location','SouthEast')
       hold on
...
% ---> Part 2 : Calculation of Absolute Errors 
    ...
    % Average Error in x & y  coordinates
      avg_error_xy_Trilateration = 0; avg_error_xy_SVR = 0; avg_error_xy_grnn = 0;    
...
f2 = figure(2);
  ...
  legend('Error in Trilateration based Estimation','GRNN based Estimation','Error in SVR based Estimation','Location','NorthWest')
 ...
 legend('Error in Trilateration based Estimation','GRNN based Estimation','Error in SVR based Estimation','Location','NorthWest')
  ...
  for t =1:no_of_positions   
    ...
    ylabel('Actual Velocity in x Direction (m/Sec)','FontName','Times','Fontsize',14,'LineWidth',2)
    hold on
  ...
  for t =1:no_of_positions
    ...
    xlabel('Time [sec]','FontName','Times','Fontsize',14,'LineWidth',2) 
    ylabel('Actual Velocity in y Direction (m/Sec)','FontName','Times','Fontsize',14,'LineWidth',2)
    hold on
    
  end
  
f7 = figure(7);
plotregression(x_actual, Trilateration_x,'Regression for Trilateration', x_actual,SVR_x,'Regression using SVR') 
f8 = figure(8);
plotregression(y_actual, Trilateration_y,'Regression for Trilateration',y_actual,SVR_y,'Regression using SVR')
 
f9 = figure(9);
plotregression(x_actual, GRNN_x,'Regression using GRNN', x_actual,SVR_x,'Regression using SVR') 
f10 = figure(10);
plotregression(y_actual, GRNN_y,'Regression using GRNN',y_actual,SVR_y,'Regression using SVR')
