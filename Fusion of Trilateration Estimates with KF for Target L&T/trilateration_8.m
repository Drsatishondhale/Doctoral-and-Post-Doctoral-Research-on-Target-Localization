function [ mobileLoc_est ] = trilateration_8( RSS,RSS_s,Pr0,n,networkSize )
%UNTITLED6 Summary of this function goes here
%   Detailed explanation goes here
% Select  highest three RSSI Values  & Calculate distances using d = antilog(Pr0-RSSI)/(10*n)
      
           d1_est = 10^(-(Pr0+RSS_s(8))/(10*n));
           d2_est = 10^(-(Pr0+RSS_s(7))/(10*n));
           d3_est = 10^(-(Pr0+RSS_s(6))/(10*n));
         ...
         elseif (RSS_s(6) == RSS(7))
             X3 = 0; Y3 = networkSize;
         elseif (RSS_s(6) == RSS(8))
